...
art.controller.Main = artjs.Class(null, {
...
art.model.Filter = artjs.Class(function(path, title) {
  this.super();
  this.addProperties({
    path: path,
    title: title
...
art.model.Item = artjs.Class(function(value, completed) {
  this.super();
  this.addProperties({
    value: value,
...
art.service.ListWatcher = artjs.Class(function(listId, updateable) {
  this._listId = listId;
...
art.view.ClearCompleted = artjs.Class(function(element) {
  this.super(element);
...
art.view.Complete = artjs.Class(function(element) {
  this.super(element);
...
art.view.Count = artjs.Class(function(element) {
  this.super(element);
...
art.view.Edit = artjs.Class(function(element) {
  this.super(element);
...
art.view.Filter = artjs.Class(function(element) {
  this.super(element);
...
art.view.Filters = artjs.Class(function(element) {
  this.super(element);
  this.setItems([ new art.model.Filter("", "All"), new art.model.Filter("active", "Active"), new art.model.Filter("completed", "Completed") ]);
}, null, {
  _name: "art.view.Filters"
}, artjs.ListView);

art.view.Footer = artjs.Class(function(element) {
  this.super(element);
  this._listWatcher = new art.service.ListWatcher("todo-list", this);
}, {
  update: function(listModel) {
...
art.view.Item = artjs.Class(function(element) {
  this.super(element);
...
art.view.ItemLabel = artjs.Class(function(element) {
  this.super(element);
...
art.view.List = artjs.Class(function(element) {
  this.super(element);
...
art.view.MarkAllComplete = artjs.Class(function(element) {
  this.super(element);
  this._listWatcher = new art.service.ListWatcher("todo-list", this);
}, {
  update: function(listModel) {
...
art.view.Main = artjs.Class(function(element) {
  this.super(element);
  this._listWatcher = new art.service.ListWatcher("todo-list", this);
}, {
  update: function(listModel) {
...
art.view.New = artjs.Class(function(element) {
  this.super(element);
  artjs.on("keydown", element, artjs.$D(this, "_onEnter"), 13);
}, {
  _onEnter: function() {
