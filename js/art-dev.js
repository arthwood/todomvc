...
artjs.component.utils.EventHandler = artjs.ComponentEventHandler = artjs.Class(function(component, eventId, delegate, type, self) {
  this._component = component;
  this._eventId = eventId;
  this._delegate = delegate;
  this._type = type;
  this._self = Boolean(self);
